    ...
    <div className="min-h-screen bg-primary flex flex-col items-center justify-center px-6 gap-8">
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="w-24 h-24 rounded-3xl bg-white/10 backdrop-blur flex items-center justify-center shadow-2xl">
          <svg className="w-12 h-12 text-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="w-full max-w-sm flex flex-col gap-3">
        <Link
          ...
          className="block w-full py-4 rounded-2xl bg-accent text-primary font-bold text-lg text-center shadow-xl active:scale-[0.98] transition-transform"
        >
          🚀 Lancer la démo
        </Link>
